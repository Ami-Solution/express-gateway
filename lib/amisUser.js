...
var AmisUser = function () {
   ...
   */
  function AmisUser(opts) {
    _classCallCheck(this, AmisUser);
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt('return', this.amis.getTeller(this.address));
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                return _context4.abrupt('return', this.amis.getTellerBalance(this.address));
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 17:
                ...
                _context5.next = 20;
                return this.amis.provider.waitForTransaction(transaction.hash);
