...
var _amisUser = require('./amisUser');

var _amisUser2 = _interopRequireDefault(_amisUser);
...
var AmisJS = function () {
   ...
   */
  function AmisJS(providerData) {
    _classCallCheck(this, AmisJS);

    /** @ignore */
    this.provider = _providers2.default.getProvider(providerData);
    /** @ignore */
    this.contractInstance = _contracts2.default.getAmisContract(this.provider);
    /** @ignore */
    this.storageInstance = _contracts2.default.getAmisStorageContract(this.provider);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 15:
                ...
                return _context2.abrupt('return', AmisJS._filterTellerList(tellers));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 10:
                ...
                return _context4.abrupt('return', AmisJS._filterTellerList(tellers).filter(function (t) {
...
AmisJS.Ethers = _ethers2.default;

exports.default = AmisJS;